...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[3127], {
    43127: function(t, e, n) {
        ...
        var r, o = n(52983), s = Object.defineProperty, i = Object.getOwnPropertySymbols, l = Object.prototype.hasOwnProperty, a = Object.prototype.propertyIsEnumerable, h = (t,e,n)=>e in t ? s(t, e, {
            enumerable: !0,
            configurable: !0,
            writable: !0,
            value: n
            ...
            if (i)
                for (var n of i(e))
                    a.call(e, n) && h(t, n, e[n]);
            return t
        }
        , c = (t,e)=>{
            var n = {};
            for (var r in t)
                l.call(t, r) && e.indexOf(r) < 0 && (n[r] = t[r]);
            if (null != t && i)
                for (var r of i(t))
                    e.indexOf(r) < 0 && a.call(t, r) && (n[r] = t[r]);
            return n
        }
        ;
        (t=>{
            const e = class {
                ...
                static encodeSegments(t, n, o=1, i=40, a=-1, h=!0) {
                    if (!(e.MIN_VERSION <= o && o <= i && i <= e.MAX_VERSION) || a < -1 || a > 7)
                        throw new RangeError("Invalid value");
                    let u, c;
                    for (u = o; ; u++) {
                        const r = 8 * e.getNumDataCodewords(u, n)
                          , o = l.getTotalBits(t, u);
                        if (o <= r) {
                            c = o;
                            break
                        }
                    ...
                    for (const r of [e.Ecc.MEDIUM, e.Ecc.QUARTILE, e.Ecc.HIGH])
                        h && c <= 8 * e.getNumDataCodewords(u, r) && (n = r);
                    let d = [];
                    for (const e of t) {
                        r(e.mode.modeBits, 4, d),
                        r(e.numChars, e.mode.numCharCountBits(u), d);
                    ...
                    s(d.length % 8 == 0);
                    for (let e = 236; d.length < f; e ^= 253)
                        r(e, 8, d);
                    let g = [];
                    for (; 8 * g.length < d.length; )
                        g.push(0);
                    return d.forEach(((t,e)=>g[e >>> 3] |= t << 7 - (7 & e))),
                    new e(u,n,g,a)
                }
                getModule(t, e) {
                ...
                drawFunctionPatterns() {
                    ...
                    for (let n = 0; n < e; n++)
                        for (let r = 0; r < e; r++)
                            0 == n && 0 == r || 0 == n && r == e - 1 || n == e - 1 && 0 == r || this.drawAlignmentPattern(t[n], t[r]);
                ...
                drawFormatBits(t) {
                    ...
                    s(r >>> 15 == 0);
                    for (let s = 0; s <= 5; s++)
                        this.setFunctionModule(8, s, o(r, s));
                    this.setFunctionModule(8, 7, o(r, 6)),
                    this.setFunctionModule(8, 8, o(r, 7)),
                    this.setFunctionModule(7, 8, o(r, 8));
                    for (let s = 9; s < 15; s++)
                        this.setFunctionModule(14 - s, 8, o(r, s));
                    for (let s = 0; s < 8; s++)
                        this.setFunctionModule(this.size - 1 - s, 8, o(r, s));
                    for (let s = 8; s < 15; s++)
                        this.setFunctionModule(8, this.size - 15 + s, o(r, s));
                ...
                drawVersion() {
                    ...
                    for (let n = 0; n < 18; n++) {
                        const t = o(e, n)
                          , r = this.size - 11 + n % 3
                          , s = Math.floor(n / 3);
                        this.setFunctionModule(r, s, t),
                        this.setFunctionModule(s, r, t)
                    }
                }
                ...
                drawAlignmentPattern(t, e) {
                    for (let n = -2; n <= 2; n++)
                        for (let r = -2; r <= 2; r++)
                            this.setFunctionModule(t + r, e + n, 1 != Math.max(Math.abs(r), Math.abs(n)))
                }
                setFunctionModule(t, e, n) {
                    this.modules[e][t] = n,
                    this.isFunction[e][t] = !0
                }
                ...
                drawCodewords(t) {
                    ...
                    for (let e = this.size - 1; e >= 1; e -= 2) {
                        ...
                        for (let r = 0; r < this.size; r++)
                            for (let s = 0; s < 2; s++) {
                                const i = e - s
                                  , l = 0 == (e + 1 & 2) ? this.size - 1 - r : r;
                                !this.isFunction[l][i] && n < 8 * t.length && (this.modules[l][i] = o(t[n >>> 3], 7 - (7 & n)),
                                n++)
                            }
                    }
                    s(n == 8 * t.length)
                ...
                getPenaltyScore() {
                    ...
                    for (let s = 0; s < this.size; s++) {
                        ...
                        for (let i = 0; i < this.size; i++)
                            this.modules[s][i] == n ? (r++,
                            5 == r ? t += e.PENALTY_N1 : r > 5 && t++) : (this.finderPenaltyAddHistory(r, o),
                            n || (t += this.finderPenaltyCountPatterns(o) * e.PENALTY_N3),
                            n = this.modules[s][i],
                            r = 1);
                ...
                static reedSolomonComputeRemainder(t, n) {
                    ...
                    for (const o of t) {
                        const t = o ^ r.shift();
                        r.push(0),
                        n.forEach(((n,o)=>r[o] ^= e.reedSolomonMultiply(n, t)))
                    }
                    return r
                }
                ...
                finderPenaltyTerminateAndCount(t, e, n) {
                    return t && (this.finderPenaltyAddHistory(e, n),
                    e = 0),
                    e += this.size,
            ...
            const i = class {
                ...
                static makeNumeric(t) {
                    ...
                    for (let n = 0; n < t.length; ) {
                        ...
                        r(parseInt(t.substr(n, o), 10), 3 * o + 1, e),
                        n += o
                    }
                ...
                static makeAlphanumeric(t) {
                    ...
                    for (e = 0; e + 2 <= t.length; e += 2) {
                        ...
                        o += i.ALPHANUMERIC_CHARSET.indexOf(t.charAt(e + 1)),
                        r(o, 11, n)
                    }
                    return e < t.length && r(i.ALPHANUMERIC_CHARSET.indexOf(t.charAt(e)), 6, n),
                ...
                static toUtf8ByteArray(t) {
                    ...
                    for (let n = 0; n < t.length; n++)
                        "%" != t.charAt(n) ? e.push(t.charCodeAt(n)) : (e.push(parseInt(t.substr(n + 1, 2), 16)),
                        n += 2);
                    return e
                }
            }
        ...
        function A(t, e=0) {
            ...
            return t.forEach((function(t, r) {
                ...
                t.forEach((function(s, i) {
                    if (!s && null !== o)
                        return n.push(`M${o + e} ${r + e}h${i - o}v1H${o + e}z`),
                        void (o = null);
                    if (i !== t.length - 1)
                        s && null === o && (o = i);
                    else {
        ...
        function p(t, e, n, r) {
            ...
            const o = n ? C : 0
              ...
              , a = (r.width || i) * l
              , h = (r.height || i) * l
              , u = null == r.x ? t.length / 2 - a / 2 : r.x * l
              , c = null == r.y ? t.length / 2 - h / 2 : r.y * l;
            let d = null;
            if (r.excavate) {
                let t = Math.floor(u)
                  , e = Math.floor(c);
        ...
        function P(t) {
            const e = t
              , {value: n, size: r=g, level: s=m, bgColor: i=E, fgColor: l=M, includeMargin: a=w, style: h, imageSettings: R} = e
              , P = c(e, ["value", "size", "level", "bgColor", "fgColor", "includeMargin", "style", "imageSettings"])
              , y = null == R ? void 0 : R.src
              , I = (0,
            o.useRef)(null)
              , S = (0,
            o.useRef)(null)
            ...
            o.useEffect)((()=>{
                if (null != I.current) {
                    ...
                    if (!e)
                        return;
                    let o = d.QrCode.encodeText(n, f[s]).getModules();
                    const h = a ? C : 0
                      , u = o.length + 2 * h
                      , c = p(o, r, a, R)
                      , g = S.current
                      , m = null != c && null !== g && g.complete && 0 !== g.naturalHeight && 0 !== g.naturalWidth;
                    m && null != c.excavation && (o = N(o, c.excavation));
                    const E = window.devicePixelRatio || 1;
                    t.height = t.width = r * E;
                    const M = r / u * E;
                    e.scale(M, M),
                    e.fillStyle = i,
                    e.fillRect(0, 0, u, u),
                    e.fillStyle = l,
                    v ? e.fill(new Path2D(A(o, h))) : o.forEach((function(t, n) {
                        t.forEach((function(t, r) {
                            t && e.fillRect(r + h, n + h, 1, 1)
                        }
                        ))
                    }
                    )),
                    m && e.drawImage(g, c.x + h, c.y + h, c.w, c.h)
                }
            }
            )),
            (0,
            ...
            let F = null;
            return null != y && (F = o.createElement("img", {
                src: y,
                key: y,
                style: {
                    display: "none"
            ...
            o.createElement(o.Fragment, null, o.createElement("canvas", u({
                style: z,
                height: r,
                width: r,
                ref: I
        ...
        function y(t) {
            const e = t
              , {value: n, size: r=g, level: s=m, bgColor: i=E, fgColor: l=M, includeMargin: a=w, imageSettings: h} = e
              , R = c(e, ["value", "size", "level", "bgColor", "fgColor", "includeMargin", "imageSettings"]);
            let v = d.QrCode.encodeText(n, f[s]).getModules();
            const P = a ? C : 0
              , y = v.length + 2 * P
              , I = p(v, r, a, h);
            let S = null;
            null != h && null != I && (null != I.excavation && (v = N(v, I.excavation)),
            S = o.createElement("image", {
                xlinkHref: h.src,
                height: I.h,
                width: I.w,
                x: I.x + P,
        ...
        var I = t=>{
            const e = t
              , {renderAs: n} = e
              , r = c(e, ["renderAs"]);
            return "svg" === n ? o.createElement(y, u({}, r)) : o.createElement(P, u({}, r))
        }
    }
}]);
